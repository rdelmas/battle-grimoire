 ...
 */
export function getSubclassNames(classId) {
 ...
 */
export function isSubclassAvailable(classId, subclassId, characterLevel) {
    const subclass = getSubclassById(classId, subclassId);
    if (!subclass)
        return false;
    return characterLevel >= subclass.level;
}
//# sourceMappingURL=srd2024-classes.js.map