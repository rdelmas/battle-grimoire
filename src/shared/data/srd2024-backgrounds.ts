...
export interface BackgroundData {
  ...
  name: string
  description: string
  skillProficiencies: string[] // Noms des compétences (clés de SkillName)
  toolProficiencies?: string[]
  languages?: number // Nombre de langues au choix
  equipment: string[]
  originFeat: {
    name: string
    description: string
 ...
 */
export const SRD2024_BACKGROUNDS: BackgroundData[] = [
  {
    id: 'acolyte',
    name: 'Acolyte',
 ...
 */
export function getAllBackgrounds(): (BackgroundData & { isCustom?: boolean })[] {
 ...
 */
export function getBackgroundById(id: string): (BackgroundData & { isCustom?: boolean }) | undefined {
 ...
 */
export function getBackgroundNames(): { id: string; name: string }[] {
